...
/** Línea de una VentaIA: un lote específico (no solo el producto) para respetar FEFO y la reserva de stock. */
@Entity
@Table(name = "detalle_venta", schema = "operaciones")
@Getter @Setter @NoArgsConstructor @AllArgsConstructor @Builder
public class DetalleVentaIA {
    ...
    @JoinColumn(name = "id_venta") private VentaIA venta;
